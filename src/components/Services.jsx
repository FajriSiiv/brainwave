  ...
  return (
    <Section crosses id="how-to-use">
      <div className="container">
        <Heading
          title="Generative AI made creators."
          text="Brainwave unlocks the potentioal of AI-powered applications"
        />
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] teext-n-3">
              ...
              <ul className="body-2">
                {brainwaveServices.map((item, index) => (
                  ...
                  >
                    <img src={check} width={24} height={24} alt="Check Icons" />
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <p className="body-2 mb-[2rem] text-n-3">
                  The world&apos;s most beautiful AI photo and video art
